...
namespace cadastro.series
{
    class Program
    {
        ...
        private static void ListarSerie()
        {
            ...
            if (lista.Count == 0)
            {
                Console.WriteLine("Não tem nenhuma série cadastrada aqui!");
                return;
            }
        ...
        public static void AtualizarSerie()
        {
            ...
            Console.Write("Digite o o gênero entre as opções acima: ");
            int entradaGenero = int.Parse(Console.ReadLine());
        ...
        {
            Console.WriteLine();
            Console.WriteLine("Cadastro de Séries ao seu dispor! :) ");
